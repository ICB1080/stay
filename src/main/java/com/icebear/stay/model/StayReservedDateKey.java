...
@Embeddable // primary key class must be annotated with @Embeddable

// StayReservedDateKey is the primary key of StayReservedDate
public class StayReservedDateKey implements Serializable {
    private static final long serialVersionUID = 1L;


    // corresponds to primary key of Stay
